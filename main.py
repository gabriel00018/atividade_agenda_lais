...
def adicionar_contato():
    if request.method == 'POST':
        ...
        flash(f'Contato{nome} adicionado com SUUUUUUUUUUUUUUUUUUUUUUUUUUUUCESSOOOOOOOO!!!!!!!!!!!')
        return redirect('/')
    else:
...
def editar_contato(codigo):
    if request.method == 'POST':
        ...
        flash(f'Contato {nome} Atualizado com SUUCEESSOOOOOOOOOOO!!!!!!!!!!!!! ')
        return redirect('/')
    else:
...
def apagar_contato(codigo):
    del contatos[codigo]
    flash(f'Contato excluido com SUCEESSOOOOOOOOOOO!!!!!!!!!!')
    return redirect('/')
